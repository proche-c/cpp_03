...
{
	if (c.getIsGuarding())
		o << "SacavTrap " << c.getName() << " has " << c.getHitPoints() << " hit points, " << c.getEnergyPoints() << " energy points, " << c.getAttackDamage() << " attack damage and it's in gate keeper mode." << std::endl;
	else
		o << "SacavTrap " << c.getName() << " has " << c.getHitPoints() << " hit points, " << c.getEnergyPoints() << " energy points, " << c.getAttackDamage() << " attack damage and it's NOT in gate keeper mode." << std::endl;
	return o;
}
